...
```python
from gppm.finance.wacc_calculator import WACCCalculator, CountryRiskParams
...
print(f"バルク処理時間: {bulk_time*1000:.2f}ms")
...
# 型エイリアス
CountryCodeType = Union[str, None]
Alpha2Code = str  # ISO 3166-1 alpha-2 code (2文字)
Alpha3Code = str  # ISO 3166-1 alpha-3 code (3文字) 
CountryCodeInput = str  # alpha-2またはalpha-3 code
